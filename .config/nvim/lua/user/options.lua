local options = {
    backup = false,                          -- creates a backup file per file edited
...
augroup yaml_syntax
    ...
    autocmd BufNewFile,BufRead *.wscene set filetype=json
    autocmd BufNewFile,BufRead *.wscene set syntax=json
    autocmd BufNewFile,BufRead *.wasset set filetype=json
    autocmd BufNewFile,BufRead *.wasset set syntax=json
