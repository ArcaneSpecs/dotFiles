...
which_key.add({
    ...
    -- FIXME: Bind this in visual mode
    { "<leader>gl", "<cmd>AdvancedGitSearch diff_commit_line<cr>",                                                                    desc = "Diff commit line",        nowait = true, remap = false },
    { "<leader>go", "<cmd>Telescope git_status<cr>",                                                                                  desc = "Open changed file",       nowait = true, remap = false },
    { "<leader>gp", "<cmd>lua require 'gitsigns'.preview_hunk()<cr>",                                                                 desc = "Preview Hunk",            nowait = true, remap = false },
    { "<leader>gr", "<cmd>lua require 'gitsigns'.reset_hunk()<cr>",                                                                   desc = "Reset Hunk",              nowait = true, remap = false },
    -- { "<leader>gs", "<cmd>lua require 'gitsigns'.stage_hunk()<cr>",                                                                   desc = "Stage Hunk",              nowait = true, remap = false },
    { "<leader>gs", "<cmd>AdvancedGitSearch<cr>",                                                                                     desc = "Advanced git search",     nowait = true, remap = false },
    -- { "<leader>gu", "<cmd>lua require 'gitsigns'.undo_stage_hunk()<cr>",                                                              desc = "Undo Stage Hunk",         nowait = true, remap = false },
    { "<leader>gu", "<cmd>AdvancedGitSearch diff_commit_file<cr>",                                                                    desc = "Diff commit file",        nowait = true, remap = false },
    { "<leader>i",  group = "Lazy",                                                                                                   nowait = true,                    remap = false },
    { "<leader>iS", "<cmd>lua require 'lazy'.stats()<cr>",                                                                            desc = "Status",                  nowait = true, remap = false },
    { "<leader>ic", "<cmd>PackerCompile<cr>",                                                                                         desc = "Compile",                 nowait = true, remap = false },
    { "<leader>ii", "<cmd>lua require 'lazy'.install()<cr>",                                                                          desc = "Install",                 nowait = true, remap = false },
    { "<leader>is", "<cmd>lua require 'lazy'.sync({ wait = true })<cr>",                                                              desc = "Sync",                    nowait = true, remap = false },
    ...
    { "<leader>sh", "<cmd>lua require('telescope.builtin').help_tags()<CR>",                                                          desc = "Help tags",               nowait = true, remap = false },
    { "<leader>sk", "<cmd>Telescope keymaps<cr>",                                                                                     desc = "Keymaps",                 nowait = true, remap = false },
    { "<leader>sr", "<cmd>Telescope oldfiles<cr>",                                                                                    desc = "Recent Files",            nowait = true, remap = false },
    { "<leader>v",  "<cmd>Alpha<cr>",                                                                                                 desc = "Alpha",                   nowait = true, remap = false },
    { "<leader>w",  "<cmd>w!<CR>",                                                                                                    desc = "Save",                    nowait = true, remap = false },
    { "<leader>y",  group = "Terminal",                                                                                               nowait = true,                    remap = false },
    { "<leader>yf", "<cmd>ToggleTerm direction=float<cr>",                                                                            desc = "Float",                   nowait = true, remap = false },
    { "<leader>yh", "<cmd>ToggleTerm size=10 direction=horizontal<cr>",                                                               desc = "Horizontal",              nowait = true, remap = false },
    { "<leader>yn", "<cmd>lua _NODE_TOGGLE()<cr>",                                                                                    desc = "Node",                    nowait = true, remap = false },
    { "<leader>yp", "<cmd>lua _PYTHON_TOGGLE()<cr>",                                                                                  desc = "Python",                  nowait = true, remap = false },
    { "<leader>yt", "<cmd>lua _HTOP_TOGGLE()<cr>",                                                                                    desc = "Htop",                    nowait = true, remap = false },
    { "<leader>yu", "<cmd>lua _NCDU_TOGGLE()<cr>",                                                                                    desc = "NCDU",                    nowait = true, remap = false },
    { "<leader>yv", "<cmd>ToggleTerm size=80 direction=vertical<cr>",                                                                 desc = "Vertical",                nowait = true, remap = false },
    { "<leader>z",  "<cmd>set wrap!<cr>",                                                                                             desc = "Toggle wrap",             nowait = true, remap = false },
});
